...
public class EmailService {
    ...
    public void sendDocumentRequestEmail(
        ...
        try {
            ...
            helper.setSubject(
                    "Submission of Required Documents – SAITEJA INFOTECH PVT LTD");
     ...
     *
     * This method is used by the Offer Letter flow.
     */
    public void sendEmailWithAttachment(
            String toEmail,
        ...
        try {
            ...
            if (ccEmails != null && !ccEmails.isEmpty()) {
                ...
                // Remove null, blank and duplicate email addresses
            ...
            if (ccEmails != null && !ccEmails.isEmpty()) {
                log.info(
                        "Offer letter email with attachment sent to: {} with {} CC recipient(s)",
                        toEmail,
                        ccEmails.stream()
                                .filter(email -> email != null)
                                .map(String::trim)
