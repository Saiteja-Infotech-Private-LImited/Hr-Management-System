...
export default function Home() {
  ...
  if (!mounted) {
    return (
      <div
        className="min-h-screen bg-[#010b1e]"
  ...
  const theme = isDark
    ...
    : {
        ...
        '--card-shadow':
          '0 8px 40px rgba(0,80,180,0.10), 0 2px 8px rgba(0,60,140,0.06)',
        ...
        '--dot-shadow': 'none',
        '--label': '#3a5580',
        '--portal-bg': 'rgba(230, 243, 255, 0.95)',
        '--portal-border': 'rgba(170, 205, 235, 1)',
        '--portal-hover-bg': 'rgba(215, 235, 252, 1)',
        '--portal-hover-border': 'rgba(100, 165, 225, 1)',
        '--icon-box-bg': '#eef5ff',
  ...
  return (
    ...
    >
      ...
      {/* ─────────────────────────────────────────────
          BACKGROUND
          CHANGED: Added light overlay to reduce
          background intensity in light mode.
      ───────────────────────────────────────────── */}
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none select-none">
        {isDark ? (
          ...
          <>
            ...
            {/* CHANGED:
                Small white overlay reduces the strong blue background
                without hiding the map, buildings or network lines.
            */}
            <div
      ...
      {/* ─────────────────────────────────────────────
          CENTRAL CARD
          CHANGED: Stronger white card + better shadow
          in light mode.
      ───────────────────────────────────────────── */}
      ...
      <div
        ...
        style={{
          ...
          border: isDark
            ...
            : '1px solid rgba(239, 248, 255, 0.97)',

          boxShadow: isDark
            ? 'var(--card-shadow)'
            : '0 25px 65px rgba(15, 60, 110, 0.16), 0 8px 25px rgba(0, 100, 200, 0.08), 0 0 0 1px rgba(255,255,255,0.7)',
      ...
      >
        {/* Inner top glow */}
        <div
          className="absolute top-0 left-1/2 -translate-x-1/2 w-48 h-20 blur-[35px] rounded-full pointer-events-none"
          style={{
        ...
        {/* HRMS */}
        <h1
          className="text-[24px] font-bold mb-1 tracking-wide"
          style={{
            color: 'var(--hrms)',
        ...
        {/* Company name */}
        <p
          className="text-[10px] font-medium mb-4 tracking-[0.18em] uppercase text-center"
          style={{
            color: 'var(--company)',
            transition: 'color 0.5s',
          }}
        ...
        {/* Divider */}
        <div
          className="w-[30px] h-[2px] rounded-full mb-5"
          style={{
            background:
              'linear-gradient(to right, #0070d0, #00b4ff)',
          }}
        />
        ...
        <div className="flex flex-col items-center mb-7 w-full">
          ...
          <div
            className="flex items-center gap-2.5 text-[9px] font-semibold uppercase tracking-widest"
            style={{
              color: 'var(--tagline)',
              transition: 'color 0.5s',
            }}
        ...
        {/* Select Portal */}
        <p
          className="text-[9.5px] font-bold mb-2.5 w-full text-left uppercase tracking-widest"
          style={{
            color: 'var(--label)',
            transition: 'color 0.5s',
          }}
        ...
        <Link
          href="/login/employee"
          className="group w-full flex items-center gap-3.5 p-3.5 mb-3 rounded-[13px] cursor-pointer relative overflow-hidden transition-all duration-300"
          style={{
        ...
        >
          <div
            className="w-9 h-9 rounded-[10px] flex items-center justify-center shrink-0 z-10 transition-all duration-300"
            style={{
        ...
        <Link
          href="/login/admin"
          className="group w-full flex items-center gap-3.5 p-3.5 mb-6 rounded-[13px] cursor-pointer relative overflow-hidden transition-all duration-300"
          style={{
            backgroundColor: 'var(--portal-bg)',
            border: '1px solid var(--portal-border)',
          }}
        ...
        <div className="flex flex-col items-center w-full text-center">
          <div
            className="py-2 px-5 rounded-[8px] mb-2"
            style={{
          ...
          >
            <p
              className="text-[8px] font-semibold uppercase tracking-[0.18em] whitespace-nowrap"
              style={{
          ...
          <p
            className="text-[7.5px] font-medium uppercase tracking-[0.18em]"
            style={{
      ...
      <button
        ...
        style={{
          ...
          boxShadow: isDark
            ? '0 0 10px rgba(0,40,120,0.35)'
            : '0 2px 8px rgba(0,60,150,0.10)',
        }}
