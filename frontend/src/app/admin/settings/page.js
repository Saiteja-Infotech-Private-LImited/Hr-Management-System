    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
        ...
        <div style={{ background: 'var(--panel-bg)', borderRadius: '14px', border: '1px solid var(--border-color)', boxShadow: '0 1px 4px rgba(0,0,0,0.04)', overflow: 'hidden' }}>
          <div style={{ padding: '16px 20px', borderBottom: '1px solid var(--border-color)', background: 'linear-gradient(135deg, var(--primary-hover), var(--primary-color))', color: 'white' }}>
            <h3 style={{ fontSize: '15px', fontWeight: '700' }}>🛡️ Admin Profile</h3>
          </div>
          <div style={{ padding: '20px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px', padding: '16px', background: 'var(--bg-input)', borderRadius: '12px' }}>
              <div style={{
        ...
        <div style={{ background: 'var(--panel-bg)', borderRadius: '14px', border: '1px solid var(--border-color)', boxShadow: '0 1px 4px rgba(0,0,0,0.04)', overflow: 'hidden' }}>
          ...
          <div style={{ padding: '20px' }}>
            <form onSubmit={handleChangePassword}>
              ...
              {/* Rules */}
              <div style={{ background: 'var(--bg-input)', borderRadius: '10px', padding: '14px', marginBottom: '20px', border: '1px solid var(--border-color)' }}>
