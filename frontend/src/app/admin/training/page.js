...
export default function TrainingPage() {
  ...
  const getDynamicStatus = (training) => {

    // Database status always wins for cancelled
  ...
  const handleSubmitTraining =
    async (e) => {
      ...
      // Only creation requires future date
      if (
        formMode === 'CREATE' &&
      ...
      if (
        ...
        toast.error(
          'Duration and Max Participants cannot be negative'
        );
    ...
    async (trainingId) => {
      ...
      const message =
        training.enrolledCount > 0
          ...
          ? `Cancel "${training.title}"?\n\n${training.enrolledCount} employee(s) are currently enrolled.\n\nThe training will be marked as CANCELLED. It will not be deleted and can be re-opened later.`

          : `Cancel "${training.title}"?\n\nThe training will be marked as CANCELLED and can be re-opened later.`;
      ...
      try {
        ...
        toast.success(
          'Training cancelled. You can re-open it later.'
        );
    ...
    async (trainingId) => {
      ...
      const message =
        training.enrolledCount > 0
          ...
          ? `Delete "${training.title}" permanently?\n\n${training.enrolledCount} employee(s) are enrolled.\n\nThe training and its enrollments will be permanently deleted. This cannot be undone.`
  ...
  return (
    ...
    <div className="max-w-7xl mx-auto px-4 py-8 space-y-6 text-slate-800 dark:text-slate-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div
          className={`bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-sm overflow-hidden transition-all duration-200 ${selected
              ? 'lg:col-span-5'
              : 'lg:col-span-12'
            }`}
        >
            ...
            <div className="p-5 border-b border-slate-100 dark:border-slate-800 bg-slate-50/50 dark:bg-slate-800/40 flex items-start justify-between gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <Badge
                    status={getDynamicStatus(selected)}
                  />
                  ...
                  selected.status !== 'COMPLETED' && (
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-blue-500/10 text-blue-600 dark:text-blue-400 border border-blue-500/20 hover:bg-blue-500/20 rounded-md text-xs font-semibold transition"
                      >
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-rose-500/10 text-rose-600 dark:text-rose-400 border border-rose-500/20 hover:bg-rose-500/20 rounded-md text-xs font-semibold transition"
                      >
                ...
                {selected.status === 'CANCELLED' && (
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-rose-500/10 text-rose-600 dark:text-rose-400 border border-rose-500/20 hover:bg-rose-500/20 rounded-md text-xs font-semibold transition disabled:opacity-50"
                    >
                            ...
                            <div className="mt-2 p-3 bg-white dark:bg-slate-900 rounded-md border border-slate-200 dark:border-slate-700 space-y-2">
                              ...
                              <div className="flex justify-end gap-2">
                                ...
                                <button
                                  ...
                                  className="px-2.5 py-1 text-[11px] bg-emerald-600 hover:bg-emerald-700 text-white font-medium rounded flex items-center gap-1 disabled:opacity-50"
                                >
          ...
          <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl shadow-xl max-w-xl w-full overflow-hidden max-h-[90vh] flex flex-col">
            ...
            <div className="p-4 border-b border-slate-100 dark:border-slate-800 flex justify-between items-center bg-slate-50/50 dark:bg-slate-800/50">
              ...
              <div>
                ...
                {formMode === 'REOPEN' && (
                  ...
                  <p className="text-[11px] text-rose-500 mt-0.5">
                    Update the details before re-opening this training.
                  </p>
              ...
              <button
                onClick={closeForm}
                disabled={submitting}
                className="p-1 text-slate-400 hover:text-slate-600 dark:hover:text-slate-200 rounded-md disabled:opacity-50"
              >
            ...
            >
              ...
              <div className="pt-4 border-t border-slate-100 dark:border-slate-800 flex justify-end gap-2">
                ...
                <button
                  ...
                  onClick={closeForm}
                  disabled={submitting}
                  className="px-4 py-2 text-xs font-medium text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg transition disabled:opacity-50"
                >
                  Cancel
                </button>
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className={`px-4 py-2 text-xs font-medium text-white rounded-lg transition flex items-center gap-1.5 disabled:opacity-50 ${formMode === 'REOPEN'
