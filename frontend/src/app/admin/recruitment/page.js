    ...
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: selectedJob ? '1fr 1.5fr' : '1fr', gap: '20px' }}>
          ...
          {loading ? (
            ...
            jobs.map((job, i) => (
              <div key={job.id}
                ...
                onMouseLeave={e => { if (selectedJob?.id !== job.id) e.currentTarget.style.background = 'var(--panel-bg)'; }}
              >
        ...
        {selectedJob && (
          <div style={{
            ...
            {loadingApps ? (
              <div style={{ padding: '40px', textAlign: 'center', color: 'var(--text-secondary)' }}>Loading applications...</div>
              ...
              applications.map((app, i) => (
                <div key={app.id} style={{ padding: '16px 20px', borderBottom: '1px solid var(--border-light)' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '8px' }}>
                  ...
                  {/* Update Status */}
                  {selectedApp === app.id ? (
                    <div style={{ background: 'var(--bg-input)', borderRadius: '8px', padding: '12px', marginTop: '8px' }}>
                      <div style={{ marginBottom: '10px' }}>
                        <select
                          value={newStatus}
                          onChange={e => setNewStatus(e.target.value)}
                          style={{ width: '100%', padding: '8px 12px', border: '1.5px solid var(--border-color)', borderRadius: '8px', fontSize: '13px', outline: 'none', background: 'var(--panel-bg)', marginBottom: '8px' }}
                        >
                        ...
                        {newStatus === 'INTERVIEW_SCHEDULED' && (
                          <input type="date" value={interviewDate}
                            ...
                            style={{ width: '100%', padding: '8px 12px', border: '1.5px solid var(--border-color)', borderRadius: '8px', fontSize: '13px', outline: 'none', boxSizing: 'border-box', marginBottom: '8px' }}
                          />
                        )}
                        ...
                        {newStatus === 'INTERVIEWED' && (
                          <>
                            ...
                            <input value={interviewNotes}
                              ...
                              style={{ width: '100%', padding: '8px 12px', border: '1.5px solid var(--border-color)', borderRadius: '8px', fontSize: '13px', outline: 'none', boxSizing: 'border-box' }}
                            />
                          </>
                        )}
                      ...
                      <div style={{ display: 'flex', gap: '8px' }}>
                        <button
                          ...
                          style={{ flex: 1, padding: '8px', background: 'var(--primary-color)', color: 'white', border: 'none', borderRadius: '7px', fontSize: '12px', fontWeight: '700', cursor: 'pointer' }}
                        >
                          {updatingApp === app.id ? '⏳' : 'Update'}
                        </button>
                        <button
                          onClick={() => { setSelectedApp(null); setNewStatus(''); }}
                          style={{ padding: '8px 14px', background: '#f1f5f9', color: 'var(--text-secondary)', border: 'none', borderRadius: '7px', fontSize: '12px', fontWeight: '600', cursor: 'pointer' }}
                        >
                          Cancel
                        </button>
                      </div>
      ...
      {showJobForm && (
        <div style={{
          ...
          <div style={{
            background: 'var(--panel-bg)', borderRadius: '16px', padding: '28px',
