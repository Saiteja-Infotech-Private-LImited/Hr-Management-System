...
export default function PayrollPage() {
  ...
  return (
    <div>
      ...
      {/* Month/Year Filter */}
      <div style={{
        background: 'var(--panel-bg)', borderRadius: '12px', padding: '16px 20px',
        border: '1px solid var(--border-color)', marginBottom: '20px',
        display: 'flex', alignItems: 'center', gap: '16px',
        boxShadow: '0 1px 4px rgba(0,0,0,0.04)',
      }}>
        <span style={{ fontSize: '13px', fontWeight: '600', color: 'var(--text-primary)' }}>Filter by:</span>
        <select
          value={month}
          ...
          style={{
            ...
            background: 'var(--panel-bg)', fontWeight: '500',
          }}
        >
          {MONTHS.map((m, i) => (
        ...
        <button
          ...
          style={{
            padding: '8px 20px', background: 'var(--primary-color)',
      ...
      {payrolls.length > 0 && (
        <div style={{ display: 'flex', gap: '14px', marginBottom: '20px' }}>
          {[
            { label: 'Total Employees', value: payrolls.length, color: 'var(--text-primary)', bg: '#eff6ff', icon: '👥' },
            ...
            <div key={i} style={{
              flex: 1, background: 'var(--panel-bg)', borderRadius: '12px',
        ...
        {loading ? (
          ...
          payrolls.map((p, i) => (
            <div key={p.id} style={{
              display: 'grid',
              gridTemplateColumns: '2fr 1.2fr 1.2fr 1.2fr 1.2fr 1fr 2fr',
              padding: '13px 20px', borderBottom: '1px solid var(--border-light)',
              alignItems: 'center',
            }}>
              {/* Employee */}
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: '11px', color: 'var(--text-secondary)' }}>{p.employeeCode}</div>
                </div>
              </div>
            ...
            <form onSubmit={handleGenerate}>
              ...
              <div style={{ marginBottom: '16px' }}>
                ...
                <select
                  ...
                  required
                  style={{ width: '100%', padding: '10px 12px', border: '1.5px solid var(--border-color)', borderRadius: '10px', fontSize: '13px', outline: 'none', background: 'var(--panel-bg)' }}
                >
              ...
              <div style={{ display: 'flex', gap: '10px' }}>
                ...
                <button type="submit" disabled={generating}
                  style={{ flex: 1, padding: '12px', background: 'var(--primary-color)', color: 'white', border: 'none', borderRadius: '10px', fontSize: '14px', fontWeight: '700', cursor: generating ? 'not-allowed' : 'pointer', opacity: generating ? 0.7 : 1 }}>
