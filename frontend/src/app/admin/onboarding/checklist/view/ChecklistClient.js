...
export default function OnboardingProfilePage() {
    ...
    if (!onboarding) {
        return <div style={{ padding: '60px', textAlign: 'center', color: 'var(--text-secondary)' }}>Employee not found.</div>;
    }
    ...
    return (
        <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '280px 1fr', gap: '20px', alignItems: 'start' }}>
                <div style={{ background: 'var(--panel-bg)', borderRadius: '12px', border: '1px solid var(--border-color)', padding: '24px', boxShadow: '0 1px 4px rgba(0,0,0,0.04)', textAlign: 'center' }}>
                    <div style={{
                    ...
                    <div style={{ textAlign: 'left', borderTop: '1px solid var(--border-color)', paddingTop: '16px' }}>
                        {[
                            ...
                            <div key={f.label} style={{ marginBottom: '12px' }}>
                                <div style={{ fontSize: '11px', color: 'var(--text-secondary)', marginBottom: '2px' }}>{f.label}</div>
                                <div style={{ fontSize: '13px', color: 'var(--text-primary)', fontWeight: '500' }}>{f.value || '—'}</div>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div>
                    <div style={{ background: 'var(--panel-bg)', borderRadius: '12px', border: '1px solid var(--border-color)', padding: '20px', marginBottom: '20px', boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
                        ...
                        <div style={{ marginTop: '16px' }}>
                            ...
                            <textarea
                                ...
                                style={{ width: '100%', padding: '10px 12px', border: '1.5px solid var(--border-color)', borderRadius: '10px', fontSize: '13px', outline: 'none', resize: 'vertical', boxSizing: 'border-box', fontFamily: 'inherit' }}
                            />
                        </div>
                        ...
                        <button
                            ...
                            style={{
                                ...
                                background: 'var(--primary-color)', color: 'white', border: 'none', borderRadius: '10px',
