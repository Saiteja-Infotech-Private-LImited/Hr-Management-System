...
export default function OnboardingDashboardPage() {
  ...
  const STATS = [
    { label: 'Total Employees', value: data.totalEmployees, sub: 'All time', color: 'var(--text-primary)', bg: '#eef2ff', icon: '👥' },
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 340px', gap: '20px' }}>
        {/* Recent Activity */}
        <div style={{ background: 'var(--panel-bg)', borderRadius: '12px', border: '1px solid var(--border-color)', padding: '18px 20px', boxShadow: '0 1px 4px rgba(0,0,0,0.04)' }}>
          ...
          {QUICK_ACTIONS.map((a, i) => (
            <button
              ...
              style={{
                ...
                background: 'var(--panel-bg)', border: '1px solid var(--border-color)', borderRadius: '10px',
