      ...
      <div className="hidden lg:flex lg:w-[45%] flex-col relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-12 lg:px-16 lg:py-16">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded bg-[#10b981] dark:bg-[#DBFF00] flex items-center justify-center transition-colors shadow-lg shadow-[#10b981]/30">
              <span className="text-white dark:text-black font-bold text-lg leading-none">H</span>
            </div>
            <span className="text-white font-bold text-[17px] tracking-tight drop-shadow-md">HRMS</span>
          </div>
          <div>
            <h1 className="text-white text-4xl xl:text-5xl font-bold leading-[1.2] mb-4 tracking-tight drop-shadow-lg">
              Let's empower<br/>your <span className="text-[#10b981] dark:text-[#DBFF00]">employees</span><br/>today.
            </h1>
      ...
      <div className="w-full lg:w-[55%] flex flex-col items-center justify-center relative p-8 dark:bg-[#0b1120]">
        ...
        <div className="w-full max-w-sm xl:max-w-md flex flex-col pt-12">
           ...
           <h2 className="text-[18px] font-bold text-slate-900 dark:text-white mb-8 text-center">
             Login first to <span className="dark:text-[#DBFF00]">your account</span>
           </h2>
           ...
           <form onSubmit={handleSubmit} className="w-full flex flex-col gap-5">
             ...
             <button 
               ...
               className={`w-full py-3 rounded-lg text-[13px] font-bold transition-all flex items-center justify-center gap-2
                 ${isFormFilled 
                   ? 'bg-[#10b981] dark:bg-[#DBFF00] text-white dark:text-slate-900 hover:bg-emerald-600 dark:hover:bg-[#a3cc00] shadow-[0_4px_14px_0_rgba(16,185,129,0.39)] dark:shadow-none' 
