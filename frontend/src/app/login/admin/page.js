...
export default function AdminLogin() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden bg-slate-900">
      ...
      <div className="absolute top-[20%] left-[-10%] w-[50%] h-[50%] rounded-full bg-emerald-600/20 blur-[120px] animate-pulse"></div>
      <div className="absolute bottom-[-20%] right-[-10%] w-[40%] h-[40%] rounded-full bg-teal-600/20 blur-[120px] animate-pulse" style={{ animationDelay: '1.5s' }}></div>
      ...
      <div className="w-full max-w-md relative z-10 backdrop-blur-xl bg-white/10 border border-white/20 p-10 rounded-3xl shadow-2xl flex flex-col transform transition-all duration-500 hover:scale-[1.01]">
        ...
        {/* Avatar */}
        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center shadow-lg shadow-emerald-500/30 mb-8 mx-auto relative group">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm font-medium text-slate-400">Secure access to HR management portal.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="w-full">
          <div className="mb-5">
            <label htmlFor="admin-email" className="block text-sm font-bold text-slate-300 mb-2 uppercase tracking-wide">Admin Email</label>
            <div className="relative group">
              ...
              <input
                ...
                required
                className="w-full bg-slate-900/50 border border-white/10 text-white placeholder-slate-500 text-sm rounded-xl focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 block p-3.5 pl-12 transition-all outline-none"
              />
            </div>
          </div>

          <div className="mb-6">
            <label htmlFor="admin-password" className="block text-sm font-bold text-slate-300 mb-2 uppercase tracking-wide">Password</label>
            <div className="relative group">
              <div className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 group-focus-within:text-emerald-400 transition-colors">
              ...
              <input
                ...
                placeholder="••••••••"
                required
                className="w-full bg-slate-900/50 border border-white/10 text-white placeholder-slate-500 text-sm rounded-xl focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500 block p-3.5 pl-12 pr-12 transition-all outline-none"
              />
          ...
          <div className="flex justify-between items-center mb-8">
            <label className="flex items-center gap-2 cursor-pointer group">
              <input type="checkbox" className="w-4 h-4 rounded border-slate-600 text-emerald-500 focus:ring-emerald-500/50 bg-slate-900/50 cursor-pointer" />
          ...
          <button type="submit" disabled={loading} className="w-full relative group overflow-hidden rounded-xl bg-emerald-600 text-white font-bold text-sm px-5 py-4 transition-all hover:bg-emerald-500 hover:shadow-[0_0_20px_rgba(16,185,129,0.4)] active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed mb-6">
