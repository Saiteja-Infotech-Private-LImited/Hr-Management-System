        ...
        <div className="h-auto p-12 lg:px-16 lg:py-14 flex flex-col justify-center bg-[#111827] dark:bg-[#0B1120] border-t dark:border-slate-800 border-transparent">
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-white font-bold text-[17px] tracking-tight">
              Saiteja Infotech Private Limited - Admin
            </span>
          ...
          <h1 className="text-white text-4xl xl:text-5xl font-bold leading-[1.1] mb-4 tracking-tight">
            Manage your
            <br />
            <span className="dark:text-[#c084fc] text-white">
              workforce
            </span>{' '}
            effectively.
          </h1>
      ...
      <div className="w-full lg:w-[55%] flex flex-col items-center justify-center relative p-8">
        ...
        <div className="w-full max-w-sm xl:max-w-md flex flex-col pt-12 -translate-y-14">
          ...
          <h2 className="text-[22px] font-bold text-slate-900 dark:text-white mb-8 text-center">
            Admin{' '}
            <span className="dark:text-[#c084fc]">
              Secure
            </span>{' '}
            Login
          </h2>
          ...
          >
            ...
            <div className="flex items-center justify-between mt-1 mb-2">
              ...
              <label className="flex items-center gap-2 cursor-pointer">
                ...
                <input
                  type="checkbox"
                  className="w-3.5 h-3.5 rounded border-slate-300 dark:border-slate-700 text-[#10b981] dark:text-[#c084fc] focus:ring-[#10b981] dark:focus:ring-[#c084fc] dark:bg-slate-800"
                />
              ...
              <button
                ...
                className="text-[11px] font-medium text-slate-500 dark:text-slate-400 hover:text-[#10b981] dark:hover:text-[#c084fc] transition-colors"
              >
                Forgot Password
              </button>
